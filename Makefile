...
download-models:
	@echo "Downloading Qwen3 Coder 30B A3B model weights..."
	$(hf) download inference-snaps/Qwen3-Coder-30B-A3B-Instruct-GGUF-Q4_K_M-5GB \
		--local-dir components/model-qwen3-coder-30b-a3b-q4-k-m-gguf
